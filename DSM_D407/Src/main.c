...
int main(void)
{
  ...
  MX_FREERTOS_Init();
	...
	Queue_Init(&osParams.USB_Out_data, DSM_AUDIO_SIZE_BYTES * 10, AUDIO_STEREO_Q15);
	Queue_Init(&osParams.USB_In_data, DSM_AUDIO_SIZE_BYTES * 10, AUDIO_STEREO_Q15);
	Queue_Init(&osParams.PCM_Out_data, DSM_AUDIO_SIZE_BYTES * 10, AUDIO_STEREO_Q15);
	Queue_Init(&osParams.PCM_In_data, DSM_AUDIO_SIZE_BYTES * 10, AUDIO_STEREO_Q15);
