...
BOOLEAN		q_bpvc_q(int16_t *bpvc, int16_t *bpvc_index,
				   int16_t num_bands);

void	q_bpvc_dec_q(int16_t bpvc[], int16_t bpvc_index, BOOLEAN uv_flag,
				   int16_t num_bands);

void	q_gain_q(int16_t *gain, int16_t *gain_index, int16_t qlow,
			   int16_t qup, int16_t qlev, int16_t qlev_q,
			   int16_t double_flag, int16_t scale);

void	q_gain_dec_q(int16_t *gain, int16_t *gain_index, int16_t qlow,
