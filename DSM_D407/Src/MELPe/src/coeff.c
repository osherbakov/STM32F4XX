...
const int16_t		lpf_num_q[(LPF_ORD/2)*3] RODATA = {                         /* Q13 */
		713, 1426, 713,
		798, 1600, 801,
		1016, 2028, 1012
};
...
const int16_t		lpf_den_q[(LPF_ORD/2)*3] RODATA = {                         /* Q13 */
		-8192, 6884, -1543,
		-8192, 7723, -2731,
		-8192, 9793, -5657
};
...
const int16_t		bpf_num_q[NUM_BANDS*((BPF_ORD/2)*3)] RODATA = {             /* Q13 */
...
const int16_t		bpf_num_class[BPF_ORD + 1] RODATA = {                     /* Q24 */
...
const int16_t 	bpf_den_q[NUM_BANDS*((BPF_ORD/2)*3)] RODATA = {
...
const int16_t 	bpf_den_class[BPF_ORD + 1] RODATA = {                     /* Q11 */
...
const int16_t 	win_cof_q[LPC_FRAME] RODATA = {
...
const int16_t 	bp_cof_q[NUM_BANDS][MIX_ORD + 1] RODATA = {
...
const int16_t 	disp_cof_q[DISP_ORD + 1] RODATA = {
