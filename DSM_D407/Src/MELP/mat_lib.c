...
/* V_EQU- vector equate */
//__inline float *v_equ(float *v1,float *v2,int n)
//{
//	arm_copy_f32(v2, v1, n);
//	return v1;
//}
//__inline int *v_equ_int(int *v1,int *v2,int n)
//{
...
//__inline float *v_scale(float *v,float scale,int n)
//{
...
//__inline float *v_sub(float *v1,float *v2,int n)
//{
...
//__inline float *v_zap(float *v,int n)
//{
//	arm_fill_f32(0.0f, v, n);
//	return v;
// } /* V_ZAP */

//__inline int *v_zap_int(int *v,int n)
//{
//	arm_fill_q31(0, v, n);
//	return v;
//} /* V_ZAP */
